...
See `FOSSIGHT_SECURITY_PRIVACY.md`. The local UI binds only to loopback. GitHub credential values are not persisted by Fossight. User data is outside the install tree and survives uninstall by design.
